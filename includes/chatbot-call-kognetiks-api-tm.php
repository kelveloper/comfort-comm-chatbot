<?php
/**
 * Steven-Bot - Transformer Model API - Ver 2.2.0
 *
...
function steven_bot_call_transformer_model_api($message, $user_id = null, $page_id = null, $session_id = null, $assistant_id = null, $client_message_id = null) {
    ...
    // Max tokens
    $max_tokens = intval(esc_attr(get_option('steven_bot_max_tokens_setting', '1024')));
    ...
    // $context = $chatgpt_last_response . ' ' . $context . ' ' . $steven_bot_kn_conversation_context;
    ...
    if ($use_enhanced_content_search == 'Yes') {
        ...
        $context = $contextInstructions . ' ' . $enhancedContext . ' ' . $context . ' ' . $steven_bot_kn_conversation_context;
    ...
    $context = '';
    $steven_bot_kn_conversation_context = '';
