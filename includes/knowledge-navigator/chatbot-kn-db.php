<?php
/**
 * Steven-Bot - Knowledge Navigator - Database and File Management - Ver 1.6.3
 *
...
function dbKNStoreTFIDF() {
    ...
    $charset_collate = $wpdb->get_charset_collate();
    $table_name = $wpdb->prefix . 'steven_bot_knowledge_base_tfidf';
...
function dbKNStoreWordCount() {
    ...
    $table_name = $wpdb->prefix . 'steven_bot_knowledge_base_word_count';
...
function store_top_words() {
    ...
    foreach ($topWords as $word => $tfidf) {
        $steven_bot_kn_conversation_context .= $word . ", ";
        }
