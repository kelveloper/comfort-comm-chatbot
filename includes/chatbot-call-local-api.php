<?php
/**
 * Steven-Bot - Local API - Ver 2.3.3
 *
...
// Call the Local API
function steven_bot_call_local_model_api($message, $user_id = null, $page_id = null, $session_id = null, $assistant_id = null, $client_message_id = null) {
...
function chatbot_local_get_models() {
    ...
    $api_key     = steven_bot_decrypt_api_key($api_key_enc);
    if (!$api_key) {
        // DIAG - Diagnostics
