<?php
/**
 * Steven-Bot - Markov Chain - Scheduler - Ver 2.1.6
 *
...
add_filter('cron_schedules', 'steven_bot_add_custom_schedules');
function steven_bot_add_custom_schedules($schedules) {
