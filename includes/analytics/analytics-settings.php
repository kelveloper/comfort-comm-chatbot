<?php
/**
 * Steven-Bot Analytics - Analytics Settings - Ver 1.0.0
 *
 * This file contains the code for the Steven-Bot Analytics settings page.
 * 
 * 
 * 
...
function kognetiks_analytics_settings_page() {
    ...
    // DIAG - Diagnostics
    // back_trace( 'NOTICE', 'Steven-Bot Analytics Settings Page Loaded');
    ...
    echo '<h1><span class="dashicons dashicons-chart-bar" style="font-size: 25px;"></span> Steven-Bot Analytics</h1>';
    echo '<p style="background-color: #e0f7fa; padding: 10px;"><b>For an explanation on how to use Analytics and additional documentation please click <a href="?page=steven-bot&file=analytics-package.md&tab=support&dir=analytics-package">here</a>.</b></p>';
    ...
    if ($active_tab === 'analytics') {
        ...
        if (
            ...
            $selected_period = get_transient('steven_bot_selected_period');
            if (!$selected_period) {
        ...
        <div class="analytics-container">
            ...
            <div class="analytics-controls-grid" style="display: grid; grid-template-columns: 220px 140px 140px 320px; gap: 16px; align-items: center; height: 50px; margin-bottom: 16px;">
                <form method="post" action="<?php echo esc_url(admin_url('admin.php?page=steven-bot')); ?>" class="period-filter-form" style="margin-bottom: 0; min-width: 220px;">
                    <?php wp_nonce_field('steven_bot_analytics_period_filter_action', 'steven_bot_analytics_period_filter_nonce'); ?>
                    <input type="hidden" name="steven_bot_analytics_action" value="period_filter" />
                    <select name="steven_bot_analytics_period_filter" id="steven_bot_analytics_period_filter" onchange="this.form.submit()" style="width: 100%;">
...
function kognetiks_analytics_start_scoring() {
    ...
    // DIAG - Diagnostics
    // back_trace( 'NOTICE', 'Steven-Bot Analytics Start Scoring Function Loaded');
