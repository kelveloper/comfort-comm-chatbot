<?php
/**
 * Steven-Bot - Retrieves the Name of the Assistant
 *
...
function get_steven_bot_assistant_name($assistant_id_lookup) {
    ...
    // back_trace( 'NOTICE', 'get_steven_bot_assistant_name() called with Assistant ID: ' . $assistant_id_lookup);
    ...
    // DIAG - Diagnostics - Ver 2.2.6
    // back_trace( 'NOTICE', 'get_steven_bot_assistant_name() response: ' . print_r($data, true));
