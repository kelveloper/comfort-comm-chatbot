<?php
/**
 * Steven-Bot - File Helper - Ver 2.0.3
 *
...
function steven_bot_text_attachment($prompt, $file_id, $beta_version = 'assistants=v1') {
...
function steven_bot_image_attachment($prompt, $file_id, $beta_version) {
