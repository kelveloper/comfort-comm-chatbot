<?php
/**
 * Steven-Bot - Download Transcript - Ver 1.9.9
 *
...
function steven_bot_download_transcript() {
    ...
    $transcript_dir = $steven_bot_plugin_dir_path . 'transcripts/';
    ...
    $url = plugins_url('transcripts/' . $transcriptFileName, $steven_bot_plugin_dir_path . 'steven-bot');
...
add_action('wp_ajax_nopriv_steven_bot_download_transcript', 'steven_bot_download_transcript');

// Delete old transcripts - Ver 1.9.9   
function steven_bot_cleanup_transcripts_directory() {

    global $steven_bot_plugin_dir_path;

    $transcripts_dir = $steven_bot_plugin_dir_path . 'transcripts/';
...
add_action('steven_bot_cleanup_transcript_files', 'steven_bot_cleanup_transcripts_directory');
