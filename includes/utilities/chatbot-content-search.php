<?php
/**
 * Steven-Bot for WordPress - Search - Ver 2.2.4 - Updated in Ver 2.2.9
 *
...
function steven_bot_content_search($search_prompt) {

    // DIAG - Diagnostics - Ver 2.2.9
    // back_trace( 'NOTICE', 'steven_bot_content_search');

    global $wpdb;

    $object = steven_bot_get_object_of_search_prompt($search_prompt);
    ...
    $post_types = steven_bot_get_searchable_post_types();
    $search_terms = steven_bot_prepare_search_terms($object);
    ...
    if (!empty($results)) {
        return steven_bot_format_search_results($results, $include_excerpt, $page, $per_page);
    }
...
function steven_bot_format_search_results($results, $include_excerpt, $page, $per_page) {

    // DIAG - Diagnostics - Ver 2.2.9
    // back_trace( 'NOTICE', 'steven_bot_format_search_results');
...
function steven_bot_get_searchable_post_types() {
...
function steven_bot_prepare_search_terms($search_prompt) {
...
function steven_bot_get_object_of_search_prompt($search_prompt) {
    global $stopWords;
