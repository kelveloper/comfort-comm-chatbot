...
function chatbot_openai_get_models() {
    ...
    if (esc_attr(get_option('steven_bot_model_choice')) === false) {
        update_option('steven_bot_model_choice', 'gpt-3.5-turbo');
    }
    if (esc_attr(get_option('steven_bot_image_model_option')) === false) {
        update_option('steven_bot_image_model_option', 'dall-e-3');
    }
    if (esc_attr(get_option('steven_bot_voice_model_option')) === false) {
        update_option('steven_bot_voice_model_option', 'tts-1-hd');
    }
    if (esc_attr(get_option('steven_bot_whisper_model_option')) === false) {
        update_option('steven_bot_whisper_model_option', 'whisper-1');
    }
    ...
    $openai_models_url = esc_attr(get_option('steven_bot_base_url'));
