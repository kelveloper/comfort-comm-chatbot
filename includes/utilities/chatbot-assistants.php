<?php
/**
 * Steven-Bot - Chatbot Assistants - Ver 2.0.4
 *
...
function create_steven_bot_assistants_table() {

    // DIAG - Diagnostics - Ver 2.2.7
    // back_trace( 'NOTCE', 'create_steven_bot_assistants_table - START' );

    global $wpdb;

    $table_name = $wpdb->prefix . 'steven_bot_assistants';
    ...
    upgrade_steven_bot_assistants_table();

    // Keep the steven_bot_number_of_shortcodes option updated - Ver 2.0.6
    // REMOVED - Ver 2.2.7
    // update_steven_bot_number_of_shortcodes();

    // DIAG - Diagnostics - Ver 2.2.7
    // back_trace( 'NOTCE', 'create_steven_bot_assistants_table - END' );
...
function drop_steven_bot_assistants_table() {
...
function get_steven_bot_assistant_by_common_name($common_name) {
...
function get_steven_bot_assistant_by_key($id) {
    ...
    if ($assistant_details) {
        $assistant_details['steven_bot_assistant_id'] = $assistant_details['assistant_id'];
        $assistant_details['common_name'] = $assistant_details['common_name'];
        $assistant_details['steven_bot_display_style'] = $assistant_details['style'];
        $assistant_details['steven_bot_audience_choice'] = $assistant_details['audience'];
        $assistant_details['steven_bot_voice_option'] = $assistant_details['voice'];
        $assistant_details['steven_bot_allow_file_uploads'] = $assistant_details['allow_file_uploads'];
        $assistant_details['steven_bot_allow_download_transcript'] = $assistant_details['allow_transcript_downloads'];
    }
...
// Keep the steven_bot_number_of_shortcodes option updated - Ver 2.0.6
function update_steven_bot_number_of_shortcodes() {

    // DIAG - Diagnostics - Ver 2.2.7
    // back_trace( 'NOTCE', 'update_steven_bot_number_of_shortcodes - START' );
    ...
    // DIAG - Diagnostics - Ver 2.2.7
    // back_trace( 'NOTCE', 'update_steven_bot_number_of_shortcodes - END' );
    
}

// Display the chatbot assistants table
function display_steven_bot_assistants_table() {
...
function steven_bot_assistants_scripts() {
...
add_action('admin_footer', 'steven_bot_assistants_scripts');
...
function upgrade_steven_bot_assistants_table() {
    ...
    $assistant_id_alternate = esc_attr(get_option('steven_bot_assistant_id_alternate'), '');
    $assistant_instructions = esc_attr(get_option('steven_bot_assistant_instructions'), '');
    $assistant_instructions_alternate = esc_attr(get_option('steven_bot_assistant_instructions_alternate'), '');

    // Insert options into steven_bot_assistants table
    if ($assistant_id) {
        $wpdb->insert(
            $table_name,
            array(
    ...
    delete_option('steven_bot_assistant_id_alternate');
    delete_option('steven_bot_assistant_instructions');
    delete_option('steven_bot_assistant_instructions_alternate');
