...
function set_steven_bot_threads($thread_id, $assistant_id, $user_id, $page_id) {

    // DIAG - Diagnostics - Ver 1.8.6
    // back_trace( 'NOTICE', 'set_steven_bot_threads');
    ...
    $thread_id_thread_key = 'steven_bot_thread_id_' . $user_id . '_' . $page_id;
    // back_trace( 'NOTICE', '$thread_id_thread_key: ' . $thread_id_thread_key);
    $assistant_id_thread_key = 'steven_bot_assistant_id_' . $user_id . '_' . $page_id;
    // back_trace( 'NOTICE', '$assistant_id_thread_key: ' . $assistant_id_thread_key);

    // Retrieve the steven_bot_thread_retention_period option
    $thread_retention_period = (int) esc_attr(get_option('steven_bot_thread_retention_period', 36));
...
// Get the threads
function get_steven_bot_threads($user_id, $session_id, $page_id, $assistant_id) {

    // DIAG - Diagnostics - Ver 1.8.6
    // back_trace( 'NOTICE', 'get_steven_bot_thread');
...
// Delete the threads
function delete_steven_bot_threads($user_id, $page_id) {

    // DIAG - Diagnostics - Ver 1.8.6
    // back_trace( 'NOTICE', 'delete_steven_bot_threads');
    // back_trace( 'NOTICE', '$user_id: ' . $user_id);
    // back_trace( 'NOTICE', '$page_id: ' . $page_id);
