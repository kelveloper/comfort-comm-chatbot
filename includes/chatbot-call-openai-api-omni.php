<?php
/**
 * Steven-Bot - ChatGPT Omni - Ver 2.0.2.1
 *
...
function steven_bot_call_omni($api_key, $message, $user_id = null, $page_id = null, $session_id = null, $assistant_id = null, $client_message_id = null) {
    ...
    $temperature = esc_attr(get_option('steven_bot_temperature', 0.5));
