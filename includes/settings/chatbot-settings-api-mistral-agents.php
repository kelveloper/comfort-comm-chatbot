<?php
/**
 * Steven-Bot - Settings - Mistral Agents - Ver 2.3.0
 *
...
function chatbot_mistral_agent_settings_init() {
    ...
    register_setting('chatbot_mistral_agents', 'chatbot_mistral_allow_file_uploads', 'steven_bot_sanitize_checkbox'); // Ver 1.7.6
    register_setting('chatbot_mistral_agents', 'chatbot_mistral_display_agents_assistant_name', 'steven_bot_sanitize_checkbox'); // Ver 1.9.4
    register_setting('chatbot_mistral_agents', 'chatbot_mistral_conversation_transcript_email', 'steven_bot_sanitize_text'); // Ver 2.2.7
    register_setting('chatbot_mistral_agents', 'assistant_id', 'steven_bot_sanitize_assistant_id'); // Ver 1.6.7
    register_setting('chatbot_mistral_agents', 'chatbot_mistral_agent_instructions', 'steven_bot_sanitize_text'); // Ver 1.9.3
    register_setting('chatbot_mistral_agents', 'chatbot_mistral_agent_id_alternate', 'steven_bot_sanitize_assistant_id'); // Alternate Agent - Ver 1.7.2
    register_setting('chatbot_mistral_agents', 'chatbot_mistral_agent_instructions_alternate', 'steven_bot_sanitize_text'); // Alternate Agent - Ver 1.9.3
    register_setting('chatbot_mistral_agents', 'chatbot_mistral_agent_beta_version', 'steven_bot_sanitize_text'); // Beta Agent - Ver 1.9.3
    register_setting('chatbot_mistral_agents', 'chatbot_mistral_thread_retention_period', 'steven_bot_sanitize_text'); // Thread Retention Period - Ver 1.9.9
    register_setting('chatbot_mistral_agents', 'chatbot_mistral_max_prompt_tokens', 'steven_bot_sanitize_float'); // Max Prompt Tokens - Ver 2.0.1
    register_setting('chatbot_mistral_agents', 'chatbot_mistral_max_completion_tokens', 'steven_bot_sanitize_float'); // Max Response Tokens - Ver 2.0.1
    register_setting('chatbot_mistral_agents', 'chatbot_mistral_enable_remote_widget', 'steven_bot_sanitize_checkbox'); // Enable Remote Widget - Ver 2.1.3
    register_setting('chatbot_mistral_agents', 'chatbot_mistral_allowed_remote_domains', 'steven_bot_sanitize_text'); // Allowed Remote Domains - Ver 2.1.3
    register_setting('chatbot_mistral_agents', 'chatbot_widget_logging', 'steven_bot_sanitize_checkbox'); // Widget Logging - Ver 2.1.3
...
function chatbot_mistral_agent_settings_section_callback($args) {
    ...
    <p style="background-color: #e0f7fa; padding: 10px;"><b>For an explanation Agent Settings and additional documentation please click <a href="?page=steven-bot&tab=support&dir=assistants&file=manage-assistants.md">here</a>.</b></p>
    <?php
}
...
function chatbot_mistral_agents_section_callback($args) {
    ...
    <p style="background-color: #e0f7fa; padding: 10px;"><b>For an explanation of the Agents General Settings and additional documentation please click <a href="?page=steven-bot&tab=support&dir=assistants&file=assistants.md">here</a>.</b></p>
    <?php
}
