<?php
/**
 * Steven-Bot - Settings - API/Gemini Page
 *
...
function chatbot_gemini_model_settings_section_callback($args) {
    ...
    <p style="background-color: #e0f7fa; padding: 10px;"><b>For an explanation of the API/Gemini settings and additional documentation please click <a href="?page=steven-bot&tab=support&dir=api-gemini-settings&file=api-gemini-model-settings.md">here</a>.</b></p>
    <?php
}
...
function chatbot_gemini_api_settings_init() {
    ...
    register_setting('chatbot_gemini_api_model', 'chatbot_gemini_api_enabled', 'steven_bot_sanitize_checkbox');
    register_setting('chatbot_gemini_api_model', 'chatbot_gemini_api_key', 'steven_bot_sanitize_api_key');
    register_setting('chatbot_gemini_api_model', 'chatbot_gemini_max_tokens_setting', 'steven_bot_sanitize_float');
    register_setting('chatbot_gemini_api_model', 'chatbot_gemini_conversation_context', 'steven_bot_sanitize_text');
    register_setting('chatbot_gemini_api_model', 'chatbot_gemini_temperature', 'steven_bot_sanitize_float');
    register_setting('chatbot_gemini_api_model', 'chatbot_gemini_top_p', 'steven_bot_sanitize_float');
    ...
    register_setting('chatbot_gemini_api_model', 'chatbot_gemini_base_url', 'steven_bot_sanitize_url');
    register_setting('chatbot_gemini_api_model', 'chatbot_gemini_timeout_setting', 'steven_bot_sanitize_text');
