<?php
/**
 * Steven-Bot - Settings - Azure OpenAI Assistants
 *
...
function chatbot_azure_assistant_settings_init() {
    ...
    register_setting('chatbot_azure_custom_gpts', 'chatbot_azure_allow_file_uploads', 'steven_bot_sanitize_checkbox'); // Ver 2.2.6
    register_setting('chatbot_azure_custom_gpts', 'chatbot_azure_display_custom_gpt_assistant_name', 'steven_bot_sanitize_checkbox'); // Ver 2.2.6
    register_setting('chatbot_azure_custom_gpts', 'assistant_id', 'steven_bot_sanitize_assistant_id'); // Ver 2.2.6
    register_setting('chatbot_azure_custom_gpts', 'chatbot_azure_assistant_instructions', 'steven_bot_sanitize_text'); // Ver 2.2.6
    register_setting('chatbot_azure_custom_gpts', 'chatbot_azure_assistant_id_alternate', 'steven_bot_sanitize_assistant_id'); // Alternate Assistant - Ver 2.2.6
    register_setting('chatbot_azure_custom_gpts', 'chatbot_azure_assistant_instructions_alternate', 'steven_bot_sanitize_text'); // Alternate Assistant - Ver 2.2.6
    register_setting('chatbot_azure_custom_gpts', 'chatbot_azure_assistant_beta_version', 'steven_bot_sanitize_text'); // Beta Assistant - Ver 2.2.6
    register_setting('chatbot_azure_custom_gpts', 'chatbot_azure_thread_retention_period', 'steven_bot_sanitize_text'); // Thread Retention Period - Ver 2.2.6
    register_setting('chatbot_azure_custom_gpts', 'chatbot_azure_max_prompt_tokens', 'steven_bot_sanitize_float'); // Max Prompt Tokens - Ver 2.2.6
    register_setting('chatbot_azure_custom_gpts', 'chatbot_azure_max_completion_tokens', 'steven_bot_sanitize_float'); // Max Response Tokens - Ver 2.2.6
    register_setting('chatbot_azure_custom_gpts', 'chatbot_azure_enable_remote_widget', 'steven_bot_sanitize_checkbox'); // Enable Remote Widget - Ver 2.2.6
    register_setting('chatbot_azure_custom_gpts', 'chatbot_azure_allowed_remote_domains', 'steven_bot_sanitize_text'); // Allowed Remote Domains - Ver 2.2.6
    register_setting('chatbot_azure_custom_gpts', 'chatbot_azure_widget_logging', 'steven_bot_sanitize_checkbox'); // Widget Logging - Ver 2.2.6
