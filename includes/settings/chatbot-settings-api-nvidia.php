<?php
/**
 * Steven-Bot - Settings - API/NVIDIA Page
 *
...
function chatbot_nvidia_model_settings_section_callback($args) {
    ...
    <p style="background-color: #e0f7fa; padding: 10px;"><b>For an explanation of the API/NVIDIA settings and additional documentation please click <a href="?page=steven-bot&tab=support&dir=api-nvidia-settings&file=api-nvidia-model-settings.md">here</a>.</b></p>                                                                                 
    <?php
}
...
function chatbot_nvidia_api_settings_init() {
    ...
    register_setting('chatbot_nvidia_api_model', 'chatbot_nvidia_api_enabled', 'steven_bot_sanitize_checkbox');
    register_setting('chatbot_nvidia_api_model', 'chatbot_nvidia_api_key', 'steven_bot_sanitize_api_key');
    register_setting('chatbot_nvidia_api_model', 'chatbot_nvidia_max_tokens_setting', 'steven_bot_sanitize_float'); // Max Tokens setting options
    register_setting('chatbot_nvidia_api_model', 'chatbot_nvidia_conversation_context', 'steven_bot_sanitize_text'); // Conversation Context
    register_setting('chatbot_nvidia_api_model', 'chatbot_nvidia_temperature', 'steven_bot_sanitize_float'); // Temperature
    register_setting('chatbot_nvidia_api_model', 'chatbot_nvidia_top_p', 'steven_bot_sanitize_float'); // Top P
    ...
    register_setting('chatbot_nvidia_api_model', 'chatbot_nvidia_base_url', 'steven_bot_sanitize_url'); // Ver 1.8.1
    register_setting('chatbot_nvidia_api_model', 'chatbot_nvidia_timeout_setting', 'steven_bot_sanitize_text'); // Ver 1.8.8
