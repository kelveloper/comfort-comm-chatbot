...
function chatbot_supabase_settings_init() {
    // Register settings
    register_setting('steven_bot_supabase', 'chatbot_supabase_project_url', 'steven_bot_sanitize_url');
    register_setting('steven_bot_supabase', 'chatbot_supabase_anon_key', 'steven_bot_sanitize_text');
    register_setting('steven_bot_supabase', 'chatbot_supabase_db_password', [
...
function chatbot_create_supabase_tables_ajax() {
    ...
    // Direct database connection is not supported in this version.
    // Please use the "Copy SQL" option and run the SQL in your Supabase SQL Editor.
    wp_send_json_error([
        'message' => 'Auto-create tables requires direct database access which is not available. Please use the "Copy SQL" option and run the SQL in your Supabase SQL Editor instead.'
    ]);
}
