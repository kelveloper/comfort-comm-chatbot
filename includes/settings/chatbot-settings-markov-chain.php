<?php
/**
 * Steven-Bot - Markov Chain - Settings - Ver 2.1.6.1
 *
...
function chatbot_markov_chain_api_settings_init() {
    ...
    register_setting('chatbot_markov_chain_api_model', 'chatbot_markov_chain_api_enabled', 'steven_bot_sanitize_checkbox'); // Ver 2.1.6
    register_setting('chatbot_markov_chain_api_model', 'chatbot_markov_chain_model_choice', 'steven_bot_sanitize_model'); // Ver 2.1.8
    register_setting('chatbot_markov_chain_api_model', 'chatbot_markov_chain_max_tokens', 'steven_bot_sanitize_float'); // Ver 2.1.9
    register_setting('chatbot_markov_chain_api_model', 'chatbot_markov_chain_build_schedule', 'steven_bot_sanitize_text'); // Ver 2.1.6
    register_setting('chatbot_markov_chain_api_model', 'chatbot_markov_chain_length', 'steven_bot_sanitize_text'); // Ver 2.1.6
    register_setting('chatbot_markov_chain_api_model', 'chatbot_markov_chain_next_phrase_length', 'steven_bot_sanitize_text'); // Ver 2.1.6
    register_setting('chatbot_markov_chain_api_model', 'chatbot_markov_chain_max_sentences', 'steven_bot_sanitize_text'); // Ver 2.2.0
    register_setting('chatbot_markov_chain_api_model', 'chatbot_markov_chain_off_topic_max', 'steven_bot_sanitize_text'); // Ver 2.2.0
    register_setting('chatbot_markov_chain_api_model', 'chatbot_markov_chain_force_rebuild', 'steven_bot_sanitize_checkbox'); // Ver 2.2.0
