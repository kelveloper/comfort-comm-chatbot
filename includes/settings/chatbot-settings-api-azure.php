<?php
/**
 * Steven-Bot - Settings - API/Azure OpenAI Page
 *
...
function chatbot_azure_model_settings_section_callback($args) {
    ...
    <p style="background-color: #e0f7fa; padding: 10px;"><b>For an explanation of the API/Azure OpenAI Settings and additional documentation please click <a href="?page=steven-bot&tab=support&dir=api-azure-openai-settings&file=api-azure-openai-model-settings.md">here</a>.</b></p>
    <?php
...
function chatbot_azure_api_settings_init() {
    ...
    register_setting('chatbot_azure_api_model', 'chatbot_azure_api_key', 'steven_bot_sanitize_api_key');
    ...
    register_setting('chatbot_azure_api_model', 'chatbot_azure_base_url', 'steven_bot_sanitize_url'); // Ver 1.8.1
    register_setting('chatbot_azure_api_model', 'chatbot_azure_resource_name', 'steven_bot_sanitize_text'); // Ver 2.2.6
    register_setting('chatbot_azure_api_model', 'chatbot_azure_deployment_name', 'steven_bot_sanitize_text'); // Ver 2.2.6
    register_setting('chatbot_azure_api_model', 'chatbot_azure_api_version', 'steven_bot_sanitize_text'); // Ver 2.2.6
    register_setting('chatbot_azure_api_model', 'chatbot_azure_timeout_setting', 'steven_bot_sanitize_text'); // Ver 1.8.8
    ...
    register_setting('chatbot_azure_api_model', 'chatbot_azure_api_enabled', 'steven_bot_sanitize_checkbox');
    register_setting('chatbot_azure_api_model', 'chatbot_azure_model_choice', 'steven_bot_sanitize_model');
    register_setting('chatbot_azure_api_model', 'chatbot_azure_max_tokens_setting', 'steven_bot_sanitize_float'); // Max Tokens setting options - Ver 2.2.6
    register_setting('chatbot_azure_api_model', 'chatbot_azure_conversation_context', 'steven_bot_sanitize_text'); // Conversation Context - Ver 2.2.6
    register_setting('chatbot_azure_api_model', 'chatbot_azure_temperature', 'steven_bot_sanitize_float'); // Temperature - Ver 2.2.6
    register_setting('chatbot_azure_api_model', 'chatbot_azure_top_p', 'steven_bot_sanitize_float'); // Top P - Ver 2.2.6
    ...
    register_setting('chatbot_azure_api_model', 'chatbot_azure_voice_model_option', 'steven_bot_sanitize_model'); // Ver 2.2.6
    register_setting('chatbot_azure_api_model', 'chatbot_azure_voice_option', 'steven_bot_sanitize_text'); // Ver 2.2.6
    register_setting('chatbot_azure_api_model', 'chatbot_azure_audio_output_format', 'steven_bot_sanitize_text'); // Ver 2.2.6
    register_setting('chatbot_azure_api_model', 'chatbot_azure_read_aloud_option', 'steven_bot_sanitize_checkbox'); // Ver 2.2.6
    ...
    register_setting('chatbot_azure_api_model', 'chatbot_azure_image_model_option', 'steven_bot_sanitize_model'); // Ver 2.2.6
    register_setting('chatbot_azure_api_model', 'chatbot_azure_image_output_format', 'steven_bot_sanitize_text'); // Ver 2.2.6
    register_setting('chatbot_azure_api_model', 'chatbot_azure_image_output_size', 'steven_bot_sanitize_text'); // Ver 2.2.6
    register_setting('chatbot_azure_api_model', 'chatbot_azure_image_output_quantity', 'steven_bot_sanitize_text'); // Ver 2.2.6
    register_setting('chatbot_azure_api_model', 'chatbot_azure_image_output_quality', 'steven_bot_sanitize_text'); // Ver 2.2.6
    register_setting('chatbot_azure_api_model', 'chatbot_azure_image_style_output', 'steven_bot_sanitize_text'); // Ver 2.2.6
    ...
    register_setting('chatbot_azure_api_model', 'chatbot_azure_whisper_model_option', 'steven_bot_sanitize_model');
    register_setting('chatbot_azure_api_model', 'chatbot_azure_whisper_response_format', 'steven_bot_sanitize_text');
