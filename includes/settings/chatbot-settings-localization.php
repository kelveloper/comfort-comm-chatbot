...
function get_localized_stopwords($language_code, $stopWords) {
    ...
    $cached_stopwords = get_transient('steven_bot_stopwords_' . $language_code);
    ...
    if ($cached_stopwords === false) {
        ...
        set_transient('steven_bot_stopwords_' . $language_code, $cached_stopwords, 31536000);
    }
...
function get_localized_learningMessages($language_code, $learningMessages) {
    ...
    $cached_learningMessages = get_transient('steven_bot_learningMessages_' . $language_code);
    ...
    if ($cached_learningMessages === false) {
        ...
        set_transient('steven_bot_learningMessages_' . $language_code, $cached_learningMessages, 31536000);
    }
...
function get_localized_errorResponses($language_code, $errorResponses) {
    ...
    $cached_errorResponses = get_transient('steven_bot_errorResponses_' . $language_code);
    ...
    if ($cached_errorResponses === false) {
        ...
        set_transient('steven_bot_errorResponses_' . $language_code, $cached_errorResponses, 31536000);
    }
