<?php
/**
 * Steven-Bot - Settings - API/Anthropic Page
 *
...
function chatbot_anthropic_model_settings_section_callback($args) {
    ...
    <p style="background-color: #e0f7fa; padding: 10px;"><b>For an explanation of the API/Anthropic settings and additional documentation please click <a href="?page=steven-bot&tab=support&dir=api-anthropic-settings&file=api-anthropic-model-settings.md">here</a>.</b></p>                                                                                 
    <?php
}
...
function chatgpt_anthropic_max_tokens_setting_callback($args) {
    // Get the saved chatbot_anthropic_max_tokens_setting or default to 500
    $max_tokens = esc_attr(get_option('chatbot_anthropic_max_tokens_setting', '500'));
...
function chatbot_anthropic_api_settings_init() {
    ...
    register_setting('chatbot_anthropic_api_model', 'chatbot_anthropic_api_enabled', 'steven_bot_sanitize_checkbox');
    register_setting('chatbot_anthropic_api_model', 'chatbot_anthropic_api_key', 'steven_bot_sanitize_api_key');
    register_setting('chatbot_anthropic_api_model', 'chatbot_anthropic_max_tokens_setting', 'steven_bot_sanitize_float'); // Max Tokens setting options
    register_setting('chatbot_anthropic_api_model', 'chatbot_anthropic_conversation_context', 'steven_bot_sanitize_text'); // Conversation Context
    register_setting('chatbot_anthropic_api_model', 'chatbot_anthropic_temperature', 'steven_bot_sanitize_float'); // Temperature
    register_setting('chatbot_anthropic_api_model', 'chatbot_anthropic_top_p', 'steven_bot_sanitize_float'); // Top P
    ...
    register_setting('chatbot_anthropic_api_model', 'chatbot_anthropic_base_url', 'steven_bot_sanitize_url'); // Ver 1.8.1
    register_setting('chatbot_anthropic_api_model', 'chatbot_anthropic_timeout_setting', 'steven_bot_sanitize_text'); // Ver 1.8.8
