<?php
/**
 * Steven-Bot - Settings - API/DeepSeek Page
 *
...
function chatbot_deepseek_model_settings_section_callback($args) {
    ...
    <p style="background-color: #e0f7fa; padding: 10px;"><b>For an explanation of the API/DeepSeek settings and additional documentation please click <a href="?page=steven-bot&tab=support&dir=api-deepseek-settings&file=api-deepseek-model-settings.md">here</a>.</b></p>
    <?php
}
...
function chatbot_deepseek_api_settings_init() {
    ...
    register_setting('chatbot_deepseek_api_model', 'chatbot_deepseek_api_enabled', 'steven_bot_sanitize_checkbox');
    register_setting('chatbot_deepseek_api_model', 'chatbot_deepseek_api_key', 'steven_bot_sanitize_api_key');
    register_setting('chatbot_deepseek_api_model', 'chatbot_deepseek_max_tokens_setting', 'steven_bot_sanitize_float'); // Max Tokens setting options
    register_setting('chatbot_deepseek_api_model', 'chatbot_deepseek_conversation_context', 'steven_bot_sanitize_text'); // Conversation Context
    register_setting('chatbot_deepseek_api_model', 'chatbot_deepseek_temperature', 'steven_bot_sanitize_float'); // Temperature
    register_setting('chatbot_deepseek_api_model', 'chatbot_deepseek_top_p', 'steven_bot_sanitize_float'); // Top P
    ...
    register_setting('chatbot_deepseek_api_model', 'chatbot_deepseek_base_url', 'steven_bot_sanitize_url');
    register_setting('chatbot_deepseek_api_model', 'chatbot_deepseek_timeout_setting', 'steven_bot_sanitize_text');
