...
function steven_bot_kn_settings_init() {

    // Knowledge Base Tab

    // Knowledge Base Settings and Schedule - Ver 2.0.0
    add_settings_section(
        'steven_bot_knowledge_navigator_settings_section',
        'Knowledge Base',
        'steven_bot_knowledge_navigator_section_callback',
        'steven_bot_knowledge_navigator'
    );

    // Knowledge Base Status
    add_settings_section(
        'steven_bot_kn_status_section',
        'Knowledge Base Status',
        'steven_bot_kn_status_section_callback',
        'steven_bot_kn_status'
    );

    // Knowledge Base Settings and Schedule - Ver 2.0.0
    register_setting('steven_bot_knowledge_navigator', 'steven_bot_kn_schedule', 'steven_bot_sanitize_text');
    register_setting('steven_bot_knowledge_navigator', 'steven_bot_kn_maximum_top_words', 'steven_bot_sanitize_text');
    register_setting('steven_bot_knowledge_navigator', 'steven_bot_kn_tuning_percentage', 'steven_bot_sanitize_text');

    add_settings_section(
        'steven_bot_kn_scheduling_section',
        'Knowledge Base Scheduling',
        'steven_bot_kn_settings_section_callback',
        'steven_bot_kn_scheduling'
    );

    add_settings_field(
        'steven_bot_kn_schedule',
        'Select Run Schedule',
        'steven_bot_kn_schedule_callback',
        'steven_bot_kn_scheduling',
        'steven_bot_kn_scheduling_section'
    );

    add_settings_field(
        'steven_bot_kn_maximum_top_words',
        'Maximum Top Words',
        'steven_bot_kn_maximum_top_words_callback',
        'steven_bot_kn_scheduling',
        'steven_bot_kn_scheduling_section'
    );

    add_settings_field(
        'steven_bot_kn_tuning_percentage',
        'Tuning Percentage',
        'steven_bot_kn_tuning_percentage_callback',
        'steven_bot_kn_scheduling',
        'steven_bot_kn_scheduling_section'
    );
    ...
    register_setting(
        ...
        [
            'type' => 'string',
            'default' => 'No',
            'sanitize_callback' => 'steven_bot_sanitize_checkbox'
        ]
    );
    ...
    foreach ($published_types as $post_type => $label) {
        ...
        add_settings_field(
            // 'steven_bot_kn_include_' . $plural_type,
            $option_name,
    ...
    register_setting('steven_bot_knowledge_navigator', 'steven_bot_suppress_learnings', 'steven_bot_sanitize_text');
    register_setting('steven_bot_knowledge_navigator', 'steven_bot_custom_learnings_message', 'steven_bot_sanitize_text');
    register_setting('steven_bot_knowledge_navigator', 'steven_bot_enhanced_response_limit', 'steven_bot_sanitize_text');
    register_setting('steven_bot_knowledge_navigator', 'steven_bot_enhanced_response_include_excerpts', 'steven_bot_sanitize_checkbox');

    add_settings_section(
        'steven_bot_kn_enhanced_response_section',
        'Knowledge Base Enhanced Response Settings',
        'steven_bot_kn_enhanced_response_section_callback',
        'steven_bot_kn_enhanced_response'
    );

    add_settings_field(
        'steven_bot_suppress_learnings',
        'Suppress Learnings Messages',
        'steven_bot_suppress_learnings_callback',
        'steven_bot_kn_enhanced_response',
        'steven_bot_kn_enhanced_response_section'
    );

    add_settings_field(
        'steven_bot_custom_learnings_message',
        'Custom Learnings Message',
        'steven_bot_custom_learnings_message_callback',
        'steven_bot_kn_enhanced_response',
        'steven_bot_kn_enhanced_response_section'
    );

    add_settings_field(
        'steven_bot_enhanced_response_limit',
        'Enhanced Response Limit',
        'steven_bot_enhanced_response_limit_callback',
        'steven_bot_kn_enhanced_response',
        'steven_bot_kn_enhanced_response_section'
    );

    add_settings_field(
        'steven_bot_enhanced_response_include_excerpts',
        'Include Post/Page Excerpts',
        'steven_bot_enhanced_response_include_excerpts_callback',
        'steven_bot_kn_enhanced_response',
        'steven_bot_kn_enhanced_response_section'
    );
    ...
    register_setting('steven_bot_kn_analysis', 'steven_bot_kn_analysis_output', 'steven_bot_sanitize_text');

    add_settings_section(
        'steven_bot_kn_analysis_section',
        'Knowledge Base Analysis',
        'steven_bot_kn_analysis_section_callback',
        'steven_bot_kn_analysis'
    );

    add_settings_field(
        'steven_bot_kn_analysis_output',
        'Output Format',
        'steven_bot_kn_analysis_output_callback',
        'steven_bot_kn_analysis',
        'steven_bot_kn_analysis_section'
    );
    ...
    add_settings_section(
        'steven_bot_faq_import_section',
        'FAQ Import',
        'steven_bot_faq_import_section_callback',
        'steven_bot_faq_import'
    );

}
add_action('admin_init', 'steven_bot_kn_settings_init');

// FAQ Import Section Callback - Ver 2.3.7
function steven_bot_faq_import_section_callback() {
    // Get FAQ count
    ...
    <?php settings_fields('steven_bot_knowledge_navigator'); ?>
    <?php
}
