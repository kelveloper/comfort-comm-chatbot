<?php
/**
 * Steven-Bot - Settings - API/Local Page
 *
...
function chatbot_local_model_settings_section_callback($args) {
    ...
    <p style="background-color: #e0f7fa; padding: 10px;"><b>For an explanation of the API/Local settings and additional documentation please click <a href="?page=steven-bot&tab=support&dir=api-local-settings&file=api-local-model-settings.md">here</a>.</b></p>
    <?php
}
...
function chatgpt_local_max_tokens_setting_callback($args) {
    // Get the saved chatbot_local_max_tokens_setting or default to 500
    $max_tokens = esc_attr(get_option('chatbot_local_max_tokens_setting', '500'));
...
function chatbot_local_api_settings_init() {
    ...
    register_setting('chatbot_local_api_model', 'chatbot_local_api_enabled', 'steven_bot_sanitize_checkbox');
    register_setting('chatbot_local_api_model', 'chatbot_local_api_key', 'steven_bot_sanitize_api_key'); // API key
    register_setting('chatbot_local_api_model', 'chatbot_local_max_tokens_setting', 'steven_bot_sanitize_float'); // Max Tokens setting options
    register_setting('chatbot_local_api_model', 'chatbot_local_conversation_context', 'steven_bot_sanitize_text'); // Conversation Context
    register_setting('chatbot_local_api_model', 'chatbot_local_temperature', 'steven_bot_sanitize_float'); // Temperature
    register_setting('chatbot_local_api_model', 'chatbot_local_top_p', 'steven_bot_sanitize_float'); // Top P
    ...
    register_setting('chatbot_local_api_model', 'chatbot_local_base_url', 'steven_bot_sanitize_url'); // Ver 2.2.6
    register_setting('chatbot_local_api_model', 'chatbot_local_timeout_setting', 'steven_bot_sanitize_text'); // Ver 2.2.6
