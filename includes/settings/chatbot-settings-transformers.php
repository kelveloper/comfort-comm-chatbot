<?php
/**
 * Steven-Bot - Transformer - Settings - Ver 2.1.6.1
 *
...
function chatbot_transformer_model_settings_section_callback($args) {
    ...
    <p style="background-color: #e0f7fa; padding: 10px;"><b>For an explanation on how to use the Transformer API and additional documentation please click <a href="?page=steven-bot&tab=support&dir=api-transformer-settings&file=api-transformer-model-settings.md">here</a>.</b></p>
    <?php
}
...
function chatbot_transformer_model_api_settings_init() {
    ...
    register_setting('chatbot_transformer_model_api_model', 'chatbot_transformer_model_api_enabled', 'steven_bot_sanitize_checkbox'); // Ver 2.1.6
    register_setting('chatbot_transformer_model_api_model', 'chatbot_transformer_model_choice', 'steven_bot_sanitize_model'); // Ver 2.1.8
    register_setting('chatbot_transformer_model_api_model', 'chatbot_transformer_model_max_tokens', 'steven_bot_sanitize_float'); // Ver 2.1.9
    register_setting('chatbot_transformer_model_api_model', 'chatbot_transformer_model_build_schedule', 'steven_bot_sanitize_text'); // Ver 2.1.6
    register_setting('chatbot_transformer_model_api_model', 'chatbot_transformer_model_word_content_window_size', 'steven_bot_sanitize_text'); // Ver 2.1.6
    register_setting('chatbot_transformer_model_api_model', 'chatbot_transformer_model_sentence_response_length', 'steven_bot_sanitize_text'); // Ver 2.1.6
    register_setting('chatbot_transformer_model_api_model', 'chatbot_transformer_model_similarity_threshold', 'steven_bot_sanitize_float'); // Ver 2.2.1
    register_setting('chatbot_transformer_model_api_model', 'chatbot_transformer_model_leading_sentences_ratio', 'steven_bot_sanitize_float'); // Ver 2.2.1
    register_setting('chatbot_transformer_model_api_model', 'chatbot_transformer_model_leading_token_ratio', 'steven_bot_sanitize_float'); // Ver 2.2.1
