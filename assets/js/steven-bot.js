jQuery(document).ready(function ($) {
    ...
    // console.log('Chatbot: NOTICE: steven-bot.js loaded.');
...
function unlockConversationOnLoad() {
    ...
    if (user_id && page_id && session_id && assistant_id) {
        $.ajax({
            ...
            data: {
                action: 'steven_bot_unlock_conversation',
                user_id: user_id,
                page_id: page_id,
...
function resetAllLocks() {
    ...
    if (user_id && page_id && session_id && assistant_id) {
        $.ajax({
            ...
            data: {
                action: 'steven_bot_reset_all_locks',
                user_id: user_id,
                page_id: page_id,
                session_id: session_id,
                assistant_id: assistant_id,
...
window.resetAllLocks = resetAllLocks;
    ...
    let steven_bot_Elements = $('#steven-bot').hide();
    let messageInput = $('#steven-bot-message');
    let conversation = $('#steven-bot-conversation');
    let submitButton = $('#steven-bot-submit');
    let chatGptOpenButton = $('#chatgpt-open-btn');

    // console.log('Chatbot: NOTICE: steven_bot_display_style: ' + kchat_settings.steven_bot_display_style);

    let steven_bot_display_style = kchat_settings.steven_bot_display_style || 'floating';
    let steven_bot_width_setting = kchat_settings.steven_bot_width_setting || 'Narrow';

    let initialGreeting = kchat_settings.steven_bot_initial_greeting || 'Hello! How can I help you today?';
    ...
    let steven_bot_start_status = kchat_settings.steven_bot_start_status || 'closed';
    let steven_bot_start_status_new_visitor = kchat_settings.steven_bot_start_status_new_visitor || 'closed';

    // Convert the timeout setting to milliseconds
    let timeout_setting = (parseInt(kchat_settings.steven_bot_timeout_setting) || 240) * 1000;
    ...
    const chatbotcollapseiconUrl = kchat_settings.steven_bot_appearance_collapse_icon || plugins_url + 'assets/icons/' + 'close_FILL0_wght400_GRAD0_opsz24.png';
    ...
    const chatboteraseiconUrl = kchat_settings.steven_bot_appearance_erase_icon || plugins_url + 'assets/icons/' + 'delete_FILL0_wght400_GRAD0_opsz24.png';
    ...
    // chatbotresizeupicon = kchat_settings.steven_bot_appearance_resize_up_icon || plugins_url + 'assets/icons/' + 'bottom_panel_open_FILL0_wght400_GRAD0_opsz24.png';
    ...
    // chatbotresizedownicon = kchat_settings.steven_bot_appearance_resize_down_icon || plugins_url + 'assets/icons/' + 'bottom_panel_close_FILL0_wght400_GRAD0_opsz24.png';
    ...
    // // chatbot-resize-icon
    // chatbotresizeicon = kchat_settings.steven_bot_appearance_resize_down_icon || plugins_url + 'assets/icons/' + 'bottom_panel_close_FILL0_wght400_GRAD0_opsz24.png';
    ...
    let chatbotresizeupiconSrc = kchat_settings.steven_bot_appearance_resize_up_icon 
        || plugins_url + 'assets/icons/bottom_panel_open_FILL0_wght400_GRAD0_opsz24.png';

    let chatbotresizedowniconSrc = kchat_settings.steven_bot_appearance_resize_down_icon 
    ...
    // console.log('Chatbot: NOTICE: steven_bot_start_status: ' + steven_bot_start_status);
    // console.log('Chatbot: NOTICE: steven_bot_start_status_new_visitor: ' + steven_bot_start_status_new_visitor);
    // console.log('Chatbot: NOTICE: steven_bot_display_style: ' + steven_bot_display_style);
    // console.log('Chatbot: NOTICE: steven_bot_width_setting: ' + steven_bot_width_setting);
    ...
    if (steven_bot_display_style === 'embedded') {
        ...
        $('#steven-bot').addClass('chatbot-embedded-style').removeClass('chatbot-floating-style');
        // Other configurations specific to embedded style
        steven_bot_start_status = 'open'; // Force the chatbot to open if embedded
        steven_bot_start_status_new_visitor = 'open'; // Force the chatbot to open if embedded
        localStorage.setItem('steven_bot_start_status', steven_bot_start_status);
        localStorage.setItem('steven_bot_start_status_new_visitor', steven_bot_start_status_new_visitor);
        steven_bot_Elements.addClass('chatbot-embedded-style').removeClass('chatbot-floating-style');
    } else {
        // console.log('Chatbot: NOTICE: Floating style detected.');
        // Apply configurations for floating style
        $('#steven-bot').addClass('chatbot-floating-style').removeClass('chatbot-embedded-style');
        // Other configurations specific to floating style
        if (steven_bot_width_setting === 'Wide') {
            steven_bot_Elements.addClass('wide');
        } else {
            // steven_bot_Elements.removeClass('wide').css('display', 'none');
            steven_bot_Elements.removeClass('wide');
        }
    }
    ...
    if (steven_bot_start_status === 'closed') {
        steven_bot_Elements.hide();
        chatGptOpenButton.show();
    } else {
        if (steven_bot_display_style === 'floating') {
            if (steven_bot_width_setting === 'Wide') {
                $('#steven-bot').removeClass('chatbot-narrow chatbot-full').addClass('chatbot-wide');
            } else {
                $('#steven-bot').removeClass('chatbot-wide chatbot-full').addClass('chatbot-narrow');
            }
            ...
            steven_bot_Elements.show();
            chatGptOpenButton.hide();
        } else {
            $('#steven-bot').removeClass('chatbot-wide chatbot-narrow').addClass('chatbot-full');
        }
    }
    ...
    $('#steven-bot-header').append(headerActions);

    // Avatar and Custom Message - Ver 1.5.0 - Upgraded - Ver 2.0.3 - 2024 05 28
    let selectedAvatar = kchat_settings.steven_bot_avatar_icon_setting || '';
    // console.log ('Chatbot: NOTICE: selectedAvatar: ' + selectedAvatar);
    let customAvatar = kchat_settings.steven_bot_custom_avatar_icon_setting || '';
    ...
    if (avatarPath !== plugins_url + 'assets/icons/icon-000.png') {
        avatarImg = $('<img>')
            .attr('id', 'steven_bot_avatar_icon_setting')
    ...
    // $('#steven-bot-header').append(chatbotCollapseBtn);
    // chatbotContainer.append(chatbotCollapsed);

    // Append the resize button to the chatbot container - Ver 2.2.7
    // $('#steven-bot-header').append(chatbotResizeBtn);
    ...
    function initializeChatbot() {
        ...
        let steven_bot_force_page_reload = kchat_settings.steven_bot_force_page_reload || 'No';
        ...
        $.ajax({
            ...
            method: 'POST',
            data: {
                action: 'steven_bot_refresh_nonce'
            },
            success: function(response) {
        ...
        isFirstTime = !localStorage.getItem('steven_bot_opened') || false;

        // Remove any legacy conversations that might be store in local storage for increased privacy - Ver 1.4.2
        localStorage.removeItem('steven_bot_conversation');

        // Clear conversation on page refresh for testing - Ver 2.3.7
        sessionStorage.removeItem('steven_bot_conversation' + '_' + assistant_id);
        localStorage.removeItem('steven_bot_opened');
        ...
        $.ajax({
            ...
            method: 'POST',
            data: {
                action: 'steven_bot_clear_context_history'
            },
            success: function() {
        ...
        if (isFirstTime) {
            ...
            let storedGreeting = kchat_settings['steven_bot_initial_greeting'];
            ...
            if (storedGreeting != null) {
                ...
                // console.log('Chatbot: NOTICE: steven-bot.js - Greeting: was not null: ' + storedGreeting);
                // console.log('Chatbot: NOTICE: steven-bot.js - Greeting: ' + initialGreeting);
            } else {
            ...
            localStorage.setItem('steven_bot_opened', 'true');
            sessionStorage.setItem('steven_bot_conversation' + '_' + assistant_id, conversation.html());
    ...
    if (steven_bot_display_style === 'floating') {
        ...
        steven_bot_Elements.append(chatbotHeader);
    ...
    function resizeChatbot() {
        ...
        let chatEl = document.getElementById('steven-bot');
        ...
        if (!enlarged) {
            ...
            $('#steven-bot-conversation')[0].style.setProperty('max-height', '90%', 'important');
            ...
            $('#steven-bot-conversation').css('max-height', '400px');
    ...
    function updateChatbotConversationMaxHeight() {
        ...
        document.getElementById('steven-bot-conversation')
    ...
    function resetIdleTimer() {
        ...
        let chatbotElement = document.getElementById('steven-bot');
        if (!chatbotElement) return;

        // Check if chatbot is visible
        let isOpen = steven_bot_Elements.is(':visible');
        if (!isOpen) return;
    ...
    function appendMessage(message, sender, cssClass) {
        ...
        let customErrorMessage = kchat_settings['steven_bot_custom_error_message'] || 'Your custom error message goes here.';
    ...
    function pollQueueStatus() {
        ...
        $.ajax({
            ...
            timeout: 5000,
            data: {
                action: 'steven_bot_get_queue_status',
                user_id: user_id,
                page_id: page_id,
                session_id: session_id,
                assistant_id: assistant_id,
    ...
    function resetMessageCount(today) {
        localStorage.setItem('steven_bot_message_count', 0); // Reset the counter
        localStorage.setItem('steven_bot_last_reset', today); // Update last reset date
    }
    ...
    submitButton.on('click', function () {
        ...
        let lastReset = localStorage.getItem('steven_bot_last_reset') || today;

        // Options: Hourly, Daily, Weekly, Monthly, Quarterly, Yearly, Lifetime
        let messageLimitPeriod = localStorage.getItem('steven_bot_message_limit_period_setting') || 'Daily';

        if (messageLimitPeriod === 'Hourly') {
            let lastResetHour = localStorage.getItem('steven_bot_last_reset_hour') || '';
            let currentHour = now.getHours();
            if (lastResetHour !== currentHour.toString()) {
                resetMessageCount(currentHour);
                localStorage.setItem('steven_bot_last_reset_hour', currentHour.toString());
            }
        ...
        let messageCount = localStorage.getItem('steven_bot_message_count') || 0;
        messageCount++;
        localStorage.setItem('steven_bot_message_count', messageCount);
      
        // If messageCount is greater than  messageLimit then don't send the message - Ver 1.9.6
        let messageLimit = localStorage.getItem('steven_bot_message_limit_setting') || 999999;
        ...
        $.ajax({
            ...
            data: {
                action: 'steven_bot_send_message',
                message: message,
            ...
            success: function (response) {
                ...
                if (kchat_settings.steven_bot_disclaimer_setting === 'No') {
                    const prefixes = [
                        "As an AI, ",
                ...
                // console.log('Chatbot: NOTICE: steven_bot_display_message_count: ' + localStorage.getItem('steven_bot_display_message_count'));
                // console.log('Chatbot: NOTICE: steven_bot_message_count: ' + localStorage.getItem('steven_bot_message_count'));
                // console.log('Chatbot: NOTICE: steven_bot_message_limit_setting: ' + localStorage.getItem('steven_bot_message_limit_setting'));
                // console.log('Chatbot: NOTICE: steven_bot_visitor_message_limit_setting: ' + localStorage.getItem('steven_bot_message_visitor_limit_setting'));

                if (localStorage.getItem('steven_bot_display_message_count') === 'Yes') {
                    let messageCount = localStorage.getItem('steven_bot_message_count') || 0;
                    let messageLimit = localStorage.getItem('steven_bot_message_limit_setting') || 999;
                    let steven_bot_visitor_message_limit_setting = localStorage.getItem('steven_bot_message_visitor_limit_setting') || 999;
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        ...
                                        if (isQueued) {
                                            ...
                                            botResponse = toSafeString(botResponse);
                                            if (kchat_settings.steven_bot_message_limit_setting === 'Yes') {
                                                let messageCount = parseInt(localStorage.getItem('steven_bot_message_count') || '0') + 1;
                                                let messageLimit = parseInt(kchat_settings.steven_bot_message_limit_period_setting || '10');
                                                let messageInfo = ` (${messageCount} / ${messageLimit})`;
                                                botResponse += messageInfo;
                                            }
    ...
    $('#steven-bot-upload-file').on('keydown', function(e) {
        if (e.keyCode === 13  && !e.shiftKey) {
            e.preventDefault();
            // console.log('Chatbot: NOTICE: Enter key pressed on upload file button');
            let $response = steven_bot_upload_files();
            $('#steven-bot-upload-file-input').trigger('click');
    ...
    $('#steven-bot-upload-mp3').on('keydown', function(e) {
        if (e.keyCode === 13  && !e.shiftKey) {
            e.preventDefault();
            // console.log('Chatbot: NOTICE: Enter key pressed on upload mp3 button');
            let $response = steven_bot_upload_mp3();
            $('#steven-bot-upload-mp3-input').trigger('click');
            let button = $(this);  // Store a reference to the button
            setTimeout(function() {
                button.trigger('blur');  // Remove focus from the button
            }, 0);
    ...
    $('#steven-bot-download-transcript-btn').on('click', function(e) {
        ...
        let conversationContent = $('#steven-bot-conversation').html();  // Get the HTML content
        let button = $(this);  // Store a reference to the button
        ...
        $.ajax({
            ...
            method: 'POST',
            data: {
                action: 'steven_bot_download_transcript',
                user_id: kchat_settings.user_id,
    ...
    $('#steven-bot-text-to-speech-btn').on('click', function(e) {

        // console.log('Chatbot: NOTICE: Text-to-Speech button clicked');

        // Read out loud the last bot response
        let lastMessage = $('#steven-bot-conversation .bot-message:last .chatbot-bot-text').text();
        let button = $(this);  // Store a reference to the button
        ...
        // Call function "steven_bot_call_tts_api" to convert the text to speech
        $.ajax({
            url: kchat_settings.ajax_url,
            method: 'POST',
            timeout: timeout_setting, // Example timeout_setting value: 10000 for 10 seconds
            data: {
                action: 'steven_bot_read_aloud',
                message: lastMessage,
                voice: kchat_settings.steven_bot_voice_option || 'alloy',
                user_id: kchat_settings.user_id,
                page_id: kchat_settings.page_id,
                session_id: kchat_settings.session_id,
    ...
    // chatbotopenicon = plugins_url + 'assets/icons/' + 'chat_FILL0_wght400_GRAD0_opsz24.png';
    chatbotmicenabledicon = kchat_settings.steven_bot_appearance_mic_enabled_icon || plugins_url + 'assets/icons/' + 'mic_24dp_000000_FILL0_wght400_GRAD0_opsz24.png';
    // console.log('Chatbot: NOTICE: kchat_settings.steven_bot_appearance_mic_enabled_icon: ' + kchat_settings.steven_bot_appearance_mic_enabled_icon);
    ...
    chatbotmicdisabledicon = kchat_settings.steven_bot_appearance_mic_disabled_icon || plugins_url + 'assets/icons/' + 'mic_off_24dp_000000_FILL0_wght400_GRAD0_opsz24.png';
    // console.log('Chatbot: NOTICE: kchat_settings.steven_bot_appearance_mic_disabled_icon: ' + kchat_settings.steven_bot_appearance_mic_disabled_icon);
    ...
    $('#steven-bot-speech-recognition-btn').empty().append(micIcon);
    ...
    if (SpeechRecognition) {
        ...
        // Add the initial icon (microphone on) to the button
        $('#steven-bot-speech-recognition-btn').on('click', function (e) {
        ...
        $('#steven-bot-speech-recognition-btn').prop('disabled', true);

        // Change the hover text to indicate that the feature is not supported
        $('#steven-bot-speech-recognition-btn').attr('title', 'Speech Recognition API not supported in this browser.');
    ...
    function handleRecognitionResult(event) {
        ...
        $('#steven-bot-message').val(transcript);
    ...
    function sendToChatbot(message) {
        ...
        $('#steven-bot-message').val(message);
    
        // Ensure that the value is updated before trying to submit
        let updatedMessage = $('#steven-bot-message').val().trim();
        ...
        if (updatedMessage) {
            ...
            $('#steven-bot-submit').trigger('click');
    ...
    $('#steven-bot-upload-file-input').on('change', function(e) {
        ...
        formData.append('action', 'steven_bot_upload_files');
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#steven-bot-upload-file-input').val(''); // Clear the file input after successful upload
    ...
    $('#steven-bot-upload-mp3-input').on('change', function(e) {
        ...
        // console.log('Chatbot: NOTICE: Files selected ' + fileField.files);
        formData.append('action', 'steven_bot_upload_mp3');
        formData.append('chatbot_nonce', kchat_settings.chatbot_upload_nonce); // Security: CSRF protection
        ...
        $.ajax({
            ...
            success: function(response) {
                // console.log('Chatbot: NOTICE: Response from server', response);
                $('#steven-bot-upload-mp3-input').val(''); // Clear the file input after successful upload
                appendMessage('File(s) successfully uploaded.', 'bot');
            },
            error: function(jqXHR, status, error) {
                if(status === "timeout") {
    ...
    $('#steven-bot-erase-btn').on('click', function() {
        ...
        $.ajax({
            ...
            timeout: timeout_setting, // Example: 10,000ms = 10 seconds
            data: {
                action: 'steven_bot_erase_conversation', // The action to be handled on the server-side
                user_id: user_id, // pass the user ID here
                page_id: page_id, // pass the page ID here
                ...
                steven_bot_force_page_reload: steven_bot_force_page_reload, // pass the force page reload setting
            ...
            success: function(response) {
                sessionStorage.removeItem('steven_bot_conversation' + '_' + assistant_id); // Clear the last response from sessionStorage
                ...
                if (kchat_settings.steven_bot_force_page_reload === 'Yes') {
    ...
    function toggleChatbot() {
        if (steven_bot_Elements.is(':visible')) {
            steven_bot_Elements.hide();
            chatGptOpenButton.show();
            localStorage.setItem('steven_bot_start_status', 'closed');
            ...
            steven_bot_Elements.show();
            chatGptOpenButton.hide();
            localStorage.setItem('steven_bot_start_status', 'open');
    ...
    function loadChatbotStatus() {
        steven_bot_start_status = localStorage.getItem('steven_bot_start_status');
        steven_bot_start_status_new_visitor = localStorage.getItem('steven_bot_start_status_new_visitor');
        ...
        // DIAG - Diagnostics - Ver 1.5.0
        // if (kchat_settings.steven_bot_diagnostics === 'On') {
        //     // console.log('Chatbot: NOTICE: loadChatbotStatus - BEFORE DECISION');
        // }

        // Decide what to do for a new visitor - Ver 1.5.0
        // if (kchat_settings.steven_bot_start_status_new_visitor === 'open') {
        //     if (steven_bot_start_status_new_visitor === null) {
        //         // Override initial status
        //         steven_bot_start_status = 'open';
        //         steven_bot_start_status_new_visitor = 'closed';
        //         localStorage.setItem('steven_bot_start_status_new_visitor', 'closed');
        //     } else {
        //         // Override initial status
        //         steven_bot_start_status_new_visitor = 'closed';
        //         localStorage.setItem('steven_bot_start_status_new_visitor', 'closed');
        ...
        // if (steven_bot_start_status_new_visitor != 'open' && steven_bot_start_status_new_visitor != 'closed') {
        //     if (steven_bot_start_status_new_visitor === null) {
        //         // Override initial status
        //         steven_bot_start_status = 'open';
        //         steven_bot_start_status_new_visitor = 'closed';
        ...
        // If the chatbot status is not set in local storage, use steven_bot_start_status - Ver 1.5.1
        if (steven_bot_start_status === 'closed') {
            steven_bot_Elements.hide();
            chatGptOpenButton.show();
        } else {
    ...
    function scrollToLastBotResponse() {
        ...
        setTimeout(() => {
            ...
            const conversation = document.querySelector('#steven-bot-conversation');
    ...
    function loadConversation() {
        ...
        localStorage.removeItem('steven_bot_opened');
        localStorage.removeItem('steven_bot_message_count');
        ...
        // Removed in Ver 1.9.3
        // storedConversation = sessionStorage.getItem('steven_bot_conversation' + '_' + assistant_id);
        ...
        if (false && kchat_settings.steven_bot_conversation_continuation === 'On') {
            storedConversation = sessionStorage.getItem('steven_bot_conversation' + '_' + assistant_id);
    ...
    function updateChatbotStyles() {
        ...
        if (isMobile() && steven_bot_display_style === 'embedded') {
            return;
        }

        const chatbotElement = document.getElementById('steven-bot');
        if (!chatbotElement) return;
